...
<div class="nav-responsive"><span>Menu</span><div class="expandable"></div></div>
  <ul class="main-navigation">
	...
	<li class="last"><a href="index.php?route=information/information&information_id=8">Каталог</a></li>		
	<li class="last"><a href="index.php?route=information/information&information_id=6">Доставкa</a></li>		
	<li class="last"><a href="index.php?route=information/information&information_id=9">Автоклиматици сервиз</a></li>	
	<?php if ($categories) { ?>
    ...
    <?php } ?>
	<?php } ?>
	<li><a href="<?php echo $contact; ?>">Контакти</a></li>	
  </ul>
</div>
