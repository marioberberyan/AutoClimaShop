				...
				<a href="<?php echo $category['href']; ?>">
					<div style="float:left">
						<?php if ($category['thumb']) { ?>
							<img align="middle" alt="<?php echo $category['name']; ?>" src="<?php echo $category['thumb']; ?>" />
						<?php } else { ?>
							<img align="middle" alt="<?php echo $category['name']; ?>" src="image/no_image.jpg" />							
						<?php } ?>						
					</div>
					<div style="float:left"><?php echo $category['name']; ?></div>
