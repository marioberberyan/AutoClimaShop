    ...
    <div class="panel-body">
      ...
      <form class="form-horizontal">
        <div class="form-group required">
          <label class="col-sm-3 col-md-4 control-label" for="input-country"><?php echo $entry_country; ?></label>
        ...
        <div class="form-group required">
          <label class="col-sm-3 col-md-4 control-label" for="input-zone"><?php echo $entry_zone; ?></label>
          <div class="col-sm-9 col-md-8">
            <select name="zone_id" id="input-zone" class="form-control"></select>
          </div>
        </div>
        <div class="form-group required">
          <label class="col-sm-3 col-md-4 control-label" for="input-postcode"><?php echo $entry_postcode; ?></label>
    ...
    success: function(json) {
      ...
      if (json['error']) {
        ...
        if (json['error']['country']) {
          $('select[name=\'country_id\']').addClass('bs-form-error');
          $('select[name=\'country_id\']').after('<div class="text-danger bs-text-notice">' + json['error']['country'] + '</div>');
        }

        if (json['error']['zone']) {
          $('select[name=\'zone_id\']').addClass('bs-form-error');
          $('select[name=\'zone_id\']').after('<div class="text-danger bs-text-notice">' + json['error']['zone'] + '</div>');
        }

        if (json['error']['postcode']) {
          $('input[name=\'postcode\']').addClass('bs-form-error');
          $('input[name=\'postcode\']').after('<div class="text-danger bs-text-notice">' + json['error']['postcode'] + '</div>');
        }
      }
