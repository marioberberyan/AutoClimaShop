	...
	<div class="right">
		...
		<div class="only-hover">
			...
			<ul>
				...
				<li class="comp"><a onclick="compare.add('<?php echo $product['product_id']; ?>');"><span>+</span> <?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?></a></li>
				<?php } ?>
				<?php if($theme_options->get( 'display_add_to_wishlist' ) != '0') { ?>
				<li class="wish"><a onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><span>+</span> <?php if($theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to wishlist'; } ?></a></li>
				<?php } ?>
			</ul>
			<?php } ?>
		</div>
