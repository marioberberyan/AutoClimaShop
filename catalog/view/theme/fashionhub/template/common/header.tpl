...
<head>
	...
	<?php if (isset($icon)) { ?>
	<link href="<?php echo isset($icon); ?>" rel="icon" />
	<?php } ?>
	...
	<?php echo isset($google_analytics); ?>    
	<!--[if lt IE 9]>
								...
								<div class="row">
									...
									<div class="col-sm-4 hidden-xs">
										...
										<div class="welcome-text">
											<?php if($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) )); } else { echo 'Call to Order: +48 500-312-312'; } ?>
										</div>
                                        ...
                                        <ul>
                                        <li><a href="https://www.facebook.com/" target="_blank"><img src="catalog/view/theme/fashionhub/img/fb_ic.png"></a></li>
                                        <li><a href="https://twitter.com/" target="_blank"><img src="catalog/view/theme/fashionhub/img/twt_ic.png"></a></li>
                                        <li><a href="https://plus.google.com/" target="_blank"><img src="catalog/view/theme/fashionhub/img/g_ic.png"></a></li>
