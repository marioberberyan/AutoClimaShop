       ...
       <?php if ($column_left || $column_right) { ?>
        ...
        <div class="<?php echo $class;?> right">
          ...
          <ul class="list-unstyled product_detail">
            <?php if ($manufacturer) { ?>
            <li><label><?php echo $text_manufacturer; ?> </label><a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></li>
            <?php } ?>
          ...
          <ul class="list-unstyled">
            ...
            <?php } else { ?>
            <li class="old"><span style="text-decoration: line-through;"><?php echo $price; ?></span></li>
            <li class="special">
             <?php echo $special; ?>
            </li>
            <?php } ?>
		 ...
		 <div id="product">
            ...
            <button type="button"  class="wishlist" data-toggle="tooltip" class="btn btn-default" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?>
				</button>
			
            <button type="button" class="compare" data-toggle="tooltip" class="btn btn-default" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><?php echo $button_compare; ?>
			</button>
          ...
          <div class="rating">
            <p>
              ...
              <?php } ?>
              <?php } ?>
              <a class="total-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a>  <a  class="write-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $text_write; ?></a></p>
			...
			?>
				...
				<div class="<?php if ($productCount >= $sliderFor){?>slider-item<?php }else{?>product-items<?php }?>">
					...
					<div class="button-group">
					 <div class="cart">
					<button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button></div>
