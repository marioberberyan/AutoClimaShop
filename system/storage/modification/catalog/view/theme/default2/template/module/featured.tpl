    ...
    <div class="col-xs-12 col-sm-6 col-md-3">
      <div class="product-thumb">
        <div class="product-thumb-inner">
          ...
          <div class="caption mh-featured-<?php echo $identifier; ?> <?php echo (!$default2['product_module_desc']) ? 'hide-teaser' : ''; ?>">
            <h4 class="mh-featured-<?php echo $identifier; ?>-title"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>

            <?php if ($default2['product_module_desc']) { ?>
              <p class="teaser mh-featured-<?php echo $identifier; ?>-teaser"><?php echo $product['description']; ?></p>
            <?php } ?>
...
{
  $('.mh-featured-<?php echo $identifier; ?>-title').matchHeight();
  $('.mh-featured-<?php echo $identifier; ?>-teaser').matchHeight(false);
  $('.mh-featured-<?php echo $identifier; ?>').matchHeight();
});
</script>
</div>