      ...
      <div class="category-info">
        ...
        <?php if ($categories) { ?>
          <div class="category-refine">
            ...
            <?php if ($default2['child_category_thumb']) { ?>
              <div class="row">
                <?php foreach ($categories as $i => $category) { $i++ ?>
                  <div class="col-xs-6 col-sm-4 col-md-3">
                    <a href="<?php echo $category['href']; ?>" class="thumbnail">
                  ...
                  <?php if ($i!=0 && !is_float($i/3)) { ?>
                    <div class="clearfix visible-sm"></div>
                  <?php } ?>
                  <?php if ($i!=0 && !is_float($i/4)) { ?>
            ...
            <?php } else { ?>
              <ul class="list-inline">
                <?php foreach ($categories as $category) { ?>
                  <li>
                    <a href="<?php echo $category['href']; ?>" class="btn btn-sm btn-default"><?php echo $category['name']; ?></a>
                  </li>
                <?php } ?>
              </ul>
            <?php } ?>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-inline">
                  ...
                  <div class="form-group">
                    <span class="control-label" for="input-limit"><?php echo $text_limit; ?></span>
            ...
            <div class="row bs-row-condensed">
              <?php foreach ($products as $product) { ?>
                <div class="product-layout product-list col-xs-12">
                  <div class="product-thumb <?php echo (!$default2['grid_product_desc']) ? 'grid-hide-teaser' : ''; ?>">
